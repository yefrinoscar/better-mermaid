...
export const presets: DiagramPreset[] = [
  {
    ...
    kind: 'Flowchart',
    description:
      'Ejemplo Claro: grupos Red Interna / Exterior, cajas redondeadas y rojos con buen contraste (claro/oscuro según la app).',
    code: `flowchart TB
...
`,
  ...
  {
    id: 'claro-variants',
    label: 'Claro — Variantes de caja',
    kind: 'Flowchart',
    description: 'Referencia de estilos Claro (default, rojo sólido, rojo punteado, chip).',
    code: `flowchart TB
  Default("Realm default")
  RedSolid("Shell / API"):::redSolid
  RedDashed("MF dashed"):::redDashed
  Chip("@claro/http"):::chip
  Default --> RedSolid --> RedDashed --> Chip
`,
  },
  {
    id: 'flow',
